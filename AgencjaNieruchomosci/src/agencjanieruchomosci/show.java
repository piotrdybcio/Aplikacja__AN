 ...
 *
 * @author Piotr
 * @about Klasa obsługuje wyświetlanie właściciela, lokalizacji
 */
public class show extends javax.swing.JFrame {
    ...
    public show() {
        initComponents();
        select.select_właściciel("SELECT * FROM Fizyczny");
        select.select_lokalizacja("SELECT ID_LOKALIZACJI, MIEJSCOWOSC, ULICA, NR_DOMU, OSIEDLE, ODLEGLOSC_OD_CENTRUM, ILOSC_SKLEPOW_W_OKOLICY, LICZBA_PRZYSTANKOW_W_OKOLICY FROM Lokalizacja");
        select.select_mieszkanie("SELECT ID_MIESZKANIE, METRAZ, L_POMIESZCZEN, POWIERZCHNIA, PIETRO, STAN, DATA_ODDANIA FROM Mieszkanie");
        select.select_dom("SELECT ID_DOM, METRAZ, KUBATURA, POWIERZCHNIA_DZIALKI, LICZBA_POMIESZCZEN, LICZBA_KONDYGNACJI, STAN FROM Dom");
        select.select_segment("SELECT ID_SEGMENTU, NR_BUD_W_SEGMENCIE, METRAZ, KUBATURA, L_POKOI, L_POMIESZCZEN, AKTUALNY_STAN FROM Segment");
